...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        last_version=$(curl -Ls "https://api.github.com/repos/jallotang007/XrayR/releases/latest" | grep '"tag_name":' | sed -E 's/.*"([^"]+)".*/\1/')
        ...
        url="https://github.com/jallotang007/XrayR/releases/download/${last_version}/XrayR-linux.zip"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/jallotang007/XrayR/master/XrayR.sh
